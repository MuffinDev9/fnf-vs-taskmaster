function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Envelope Note' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'ENVELOPE_assets'); --Change texture
...
function goodNoteHit(id, noteData, noteType, isSustainNote)
	if noteType == 'Envelope Note' then
