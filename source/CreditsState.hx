...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		['Taskmaster People'],
		['Greg Davies',		'GRG',		'THE Taskmaster',		'https://en.wikipedia.org/wiki/Greg_Davies',		'0xFFD10616'],
		['Little Alex Horne',		'ALX',		'The Owner Of Taskmaster / Greg\'s Slave',		'https://en.wikipedia.org/wiki/Alex_Horne',		'0xFFD10616'],
		['James Acaster',		'JMS',		'Singer Of Over My Shoulder',		'https://en.wikipedia.org/wiki/James_Acaster',		'0xFFD10616'],
		['Mark Watson',		'MRK',		'Drummer In Im Always Seeing You(Do Cool Stuff)',		'https://en.wikipedia.org/wiki/Mark_Watson',		'0xFFD10616'],
		['Nish Kumar',		'NSH',		'Guitarist In Im Always Seeing You(Do Cool Stuff)',		'https://en.wikipedia.org/wiki/Nish_Kumar',		'0xFFD10616'],
		['Mod Developers'],
		['Muffin Dev',		'MuffinDev',		'I made this mod all by myself lol',		'https://github.com/MuffinDev9',		'0xFFC30085'],
		[''],
		['Psych Engine Team'],
